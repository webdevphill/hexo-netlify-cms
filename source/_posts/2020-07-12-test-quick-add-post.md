---
layout: blog
title: Test Quick Add Post
date: '2020-07-12T13:29:39+10:00'
thumbnail: /images/uploads/hollow-knight-whitebg.png
---
...
```
private SomeFunction() {    // Comment about operation    if (true)    {        // Do the thing        }}
```
